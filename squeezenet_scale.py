...
wb = pd.DataFrame()
wb.to_excel("squeeze_result_"+str(args.reduce_resolution)+".xlsx")
...
def train_model(model, dataloaders, criterion, optimizer, scheduler, num_epochs, is_inception=False,rst_dir='./rst/exp'):
    ...
    for epoch in range(num_epochs):
        ...
        #print(log)
        wb = load_workbook("squeeze_result_" + str(args.reduce_resolution) + ".xlsx")
        wb1 = wb.active
        ...
        wb.save("squeeze_result_" + str(args.reduce_resolution) + ".xlsx")
...
if __name__ == '__main__':
    ...
    model_ft = models.squeezenet1_1(pretrained=preTrain)
    model_ft.classifier[1].out_channels = 2
